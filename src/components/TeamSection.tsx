    ...
    <section id="team" className="py-24 bg-hexa-bg relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 font-mono-plex max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-hexa-card border border-hexa-cyan/30 p-8 rounded-xl flex flex-col items-center text-center relative group hover:bg-[#130d24] transition-colors">
                ...
                <h4 className="text-2xl font-display text-white mb-1">Lead Architect</h4>
                <p className="text-sm text-hexa-cyan font-mono-plex uppercase tracking-wider mb-4">Founder / Maintainer</p>
                <p className="text-gray-400 text-base font-mono-plex leading-relaxed mb-6">
            ...
            <div className="bg-hexa-card border border-hexa-purple/30 p-8 rounded-xl flex flex-col items-center text-center relative group hover:bg-[#130d24] transition-colors">
                ...
                <h4 className="text-2xl font-display text-white mb-1">Stealth Contributors</h4>
                <p className="text-sm text-hexa-purple font-mono-plex uppercase tracking-wider mb-4">Industrial Veterans</p>
                <p className="text-gray-400 text-base font-mono-plex leading-relaxed mb-6">
            ...
            <div className="bg-hexa-card border border-white/10 p-8 rounded-xl flex flex-col items-center text-center relative group hover:bg-[#130d24] transition-colors">
                ...
                <h4 className="text-2xl font-display text-white mb-1">The Community</h4>
                <p className="text-sm text-gray-500 font-mono-plex uppercase tracking-wider mb-4">Testers & Makers</p>
                <p className="text-gray-400 text-base font-mono-plex leading-relaxed mb-6">
