  ...
  return (
    <section id="market" className="bg-hexa-bg py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {STATS.map((stat, i) => (
            <Reveal key={stat.value} delay={i * 100}>
              <div className="space-y-3 border-t border-white/10 pt-6">
                <span className="block font-mono-plex text-5xl text-white sm:text-4xl md:text-5xl [font-variant-numeric:tabular-nums]">
                  {stat.value}
                </span>
                <span className="block max-w-[26ch] font-sans text-base leading-relaxed text-hexa-ink2 sm:text-sm">
                  {stat.label}
                </span>
              </div>
            </Reveal>
        ...
        <Reveal delay={200}>
          <p className="mt-16 max-w-2xl font-sans text-lg leading-relaxed text-hexa-ink2 sm:text-lg">
